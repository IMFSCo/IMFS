...
class InheritPurchase(models.Model):
    ...
    @api.multi
    def button_approval_one(self):
        return self.write({'state':'approval1','first_email':self.user_id.email_formatted})

    @api.multi
    def button_approval_two(self):
        return self.write({'state':'approval2','second_email':self.user_id.email_formatted})

    @api.multi
    def button_approval_three(self):
        return self.write({'state':'approval3','third_email':self.user_id.email_formatted})

    @api.multi
    def button_approval_four(self):
        return self.write({'state':'approval4','fourth_email':self.user_id.email_formatted})
